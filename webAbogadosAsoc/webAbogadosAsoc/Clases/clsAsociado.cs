...
namespace webAbogadosAsoc.Clases
{
    public class clsAsociado
    {
        ...
        public clsAsociado(string Aplicacion, string nroDocu, string tipoDocu, string Nombres, bool Activado)
        {
            strApp = Aplicacion;
            nroDoc = nroDocu;
            tipoDoc = tipoDocu;
        ...
        private bool validarDatos()
        {
            ...
            {
                Error = "Falta el numero del documento";
                return false;
            }
        ...
        public bool buscar(string nroDocumento)
        {
            try
            {
                strSQL = "EXEC_USP_Asoc_BuscarXcodigo" + nroDocumento + ";";
                clsConexionBD objCnx = new clsConexionBD(strApp);
                objCnx.SQL = strSQL;
                ...
                if (!myReader.HasRows)
                {
                    Error = "No existe registro con Nro. documento " + nroDocumento;
                    objCnx.cerrarCnx();
                    objCnx = null;
                    return false;
                }
        ...
        public bool grabarMaestro()
        {
            ...
            strSQL = "EXEC USP_Asoc_Grabar" + nroDoc + "," + tipoDoc + "," + "'" + Nombre + "'," + intAct + ";";
            return Grabar();
        }
        public bool modificarMaestro()
        {
            if (validarDatos())
                return false;
            int intAct = Activo ? 1 : 0;
            strSQL = "EXEC USP_Asoc_Modificar" + nroDoc + "," + tipoDoc + "," + "'" + Nombre + "'," + intAct + ";";
            return Grabar();
        }
